...
from emocoder.src import data, constants
...
from emocoder.experiments.text.proposed import Exp
from copy import deepcopy

PARENTDIR = xconstants.TEXT_ZEROSHOT_BASEPATH / "dev"
TESTDIR = xconstants.TEXT_ZEROSHOT_BASEPATH  / "test"
PRETRAINED_DIR = xconstants.TEXT_PROPOSED_BASEPATH / "dev"
...
#                          checkpoint=get_best_checkpoint(get_experiment_dir(PRETRAINED_DIR, "emobank")),
#                          test_batchsize=48,
#                          checkpoint_exact_match=False), # I added a secondary decoder for polarity after running the emobank sng experiment
]
